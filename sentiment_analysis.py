...
def process_movie_reviews(file_path, title):
...
# List of movie review datasets with titles
movie_datasets = [
    ('cleaned_imdbreviews_3idiots2009.csv', '3 Idiots'),
    ('cleaned_imdbreviews_saw2004.csv', 'Saw'),
    ('cleaned_imdbreviews_thelionking1994.csv', 'The Lion King')
]

for file_path, title in movie_datasets:
    process_movie_reviews(file_path, title)
