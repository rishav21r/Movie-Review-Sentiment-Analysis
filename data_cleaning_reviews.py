...
def clean_and_process_data():
    ...
    path_saw = 'imdbreviews_saw2004.csv'
    path_3idiots = 'imdbreviews_3idiots2009.csv'
    path_lionking = 'imdbreviews_thelionking1994.csv'
    ...
    data_saw_clean.to_csv('cleaned_imdbreviews_saw2004.csv', index=False)
    data_3idiots_clean.to_csv('cleaned_imdbreviews_3idiots2009.csv', index=False)
    data_lionking_clean.to_csv('cleaned_imdbreviews_thelionking1994.csv', index=False)
...
print(f"Saw (2009): {cleaned_data_saw.shape[0]} entries.")
